...
export const Footer = () => {
  ...
  const socialLinks = [
    { icon: <Linkedin size={18} />, href: "https://www.linkedin.com/in/rida-sersif-721497330/", label: "LinkedIn" },
    { icon: <Instagram size={18} />, href: "https://instagram.com/ridasersif", label: "Instagram" },
    { icon: <Youtube size={18} />, href: "https://youtube.com/@ridasersif", label: "YouTube" },
    { icon: <Github size={18} />, href: "https://github.com/ridasersif", label: "GitHub" },
  ];
  ...
  const contactInfo = [
    { icon: <Mail size={16} />, text: "ridasersif1@gmail.com", href: "mailto:ridasersif1@gmail.com" },
    { icon: <Phone size={16} />, text: "+212 650052037", href: "tel:+212650052037" },
  ];
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <motion.div variants={itemVariants} className="space-y-4">
              <h3 className="text-xl font-bold text-gray-900 dark:text-white">SERSIF</h3>
          ...
          >
            <div>
              <p>© {currentYear} Sersif. All rights reserved.</p>
            </div>
