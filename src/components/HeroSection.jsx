  ...
  return (
    ...
    >
      ...
      <div className="container max-w-5xl mx-auto text-center z-10">
        ...
        >
          ...
          <motion.p 
            ...
            variants={itemVariants}
          >
            Building <span className="text-primary font-medium">web and mobile applications</span> that combine <span className="text-secondary font-medium">beautiful design</span> with <span className="text-primary font-medium">modern technologies</span> to solve real-world problems.
          </motion.p>
      ...
      <motion.div 
        ...
        animate="float"
      >
        {['React', 'Node.js', 'TypeScript', 'Java', 'MongoDB','PHP'].map((tech, i) => (
          <motion.div 
            key={tech}
      ...
      <motion.div 
        ...
        animate="float"
      >
        {['Express', 'Next.js', 'PostgreSQL', 'Tailwind', 'Docker','Laravel'].map((tech, i) => (
          <motion.div 
            key={tech}
            className="px-4 py-2 bg-background/80 backdrop-blur-sm border rounded-full text-sm shadow-sm"
            initial={{ x: 20, opacity: 0 }}
